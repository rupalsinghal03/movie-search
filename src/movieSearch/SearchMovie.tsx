...
import { getSearchedMovies, getPopularMovies, MEDIA_BASEURL } from '../apis/api.methods';
            ...
            <div className="row">
                <div className="col-12 pt-4 align-items-center">
                    <div className="page-title mb-4">
                        {query ? (<h3>Searched Results for: {query}</h3>): (<h3>Popular Movies!</h3>)}
                    </div>
                                    ...
                                    <div key={index} className="col-lg-4 col-md-6 mb-4">
                                        <div className="card p-4 d-flex flex-row justify-content-between align-items-center">
                                            <div className="card-body">
                                                <img src={MEDIA_BASEURL + data.backdrop_path} className="card-img-top" style={{ width: "100%", height: "150px" }} />
                                ...
                                <div className="col-12">
                                    <div className="pagination d-flex justify-content-between mb-4">
                                        ...
                                        {showPages.map((page, index) => (
                                            <button key={index} className='btn btn-secondary rounded-circle' onClick={() => { handleCustomPage(page) }}>{page}</button>
                                        ))}
